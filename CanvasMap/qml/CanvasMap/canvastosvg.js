...
var CanvasSVG = (typeof exports === "undefined")?(function CanvasSVG() {}):(exports);
if(typeof global !== "undefined") { global.CanvasSVG = CanvasSVG; }
...
function XMLElement(ns, ln, attr) {
    this.elem_name = ns;
    this.elem_name = ln;
    this.attrs = attr;
};

function createElement(ns, ln, attr) {
    return new XMLElement(ns, ln, attr);
}
...
CanvasSVG.Base.prototype = {
    ...
    wrapCanvas: function (c) {
        ...
        var obj = this;
//        console.log(Numeric.numeric.prettyPrint([1,2,3]));
        this.el = c;
...
//        c.canvasSVGWrapper = true;
    ...
    getCTSContext: function (dim) {
        console.log("ctx", this)
        this.context = this.el.getContext(dim);
        return this.el.getContext(dim);
    },
        
    // --- SVG basics
    makeElement:    function (ln, attr, txt, parent) {
        console.log("making", ln, attr, txt, parent);
        var el = createElement(this.ns, ln, attr);
//        if (attr) {
//            for (var k in attr) {
...
//        this.context[sName]; });
    Object.defineProperty(CanvasSVG.Deferred.prototype, sName,
                          {
                              get: function() {return this.context[sName];},
                              set: function(val) {
